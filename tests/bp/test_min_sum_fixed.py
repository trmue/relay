...
def test_decode_detailed(repetition_code_config_fixed):
    decoder = relay_bp.MinSumBPDecoderFixed(**repetition_code_config_fixed)
...
def test_decode_detailed_batch(repetition_code_config_fixed):
    decoder = relay_bp.MinSumBPDecoderFixed(**repetition_code_config_fixed)
